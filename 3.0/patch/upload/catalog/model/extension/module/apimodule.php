...
class ModelExtensionModuleApimodule extends Model
{
    ...
    public function addProduct($data) {
        ...
        if (isset($data['product_store'])) {
            $siteIds = array_diff($data['product_store'], array(''));
            ...
            foreach ($data['product_attribute'] as $product_attribute) {
                if ($product_attribute['attribute_id']) {
                    ...
                    foreach ($product_attribute['product_attribute_description'] as $language_id => $product_attribute_description) {
                        ...
                        $this->db->query("INSERT INTO " . DB_PREFIX . "product_attribute SET product_id = '" . (int)$product_id . "', attribute_id = '" . (int)$product_attribute['attribute_id'] . "', language_id = '" . (int)$this->config->get('config_language_id') . "', text = '" .  $this->db->escape($product_attribute_description['text']) . "'");
                    }
                }
            }
        }
