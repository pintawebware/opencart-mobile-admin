...
require_once DIR_CATALOG . "model/extension/module/apimodule.php";
...
class ControllerExtensionModuleApimodule extends Controller {
	...
	public function __construct( $registry ) {
		...
		$api = new ModelExtensionModuleApimodule($this->registry);
	...
	public function index() {
		...
		$data['update'] = $this->url->link('extension/module/apimodule/update&v='.$version, 'user_token=' . $this->session->data['user_token'], true);
...
//            $this->model_setting_event->addEvent('apimodule', 'post.order.history.add', 'module/apimodule/sendNotifications');
            $this->model_setting_event->addEvent('apimodule', 'admin/model/catalog/product/Product/after', 'module/apimodule/sendNotifications');
        }
