...
$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX."user_device_mob_api` (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, user_id INT NOT NULL, device_token VARCHAR(500) , os_type VARCHAR(50))");
...
if(VERSION == '2.0.0.0' ){
	...
	$this->load->model('tool/event');
	$this->model_tool_event->deleteHandler('apimodule');
